...
%>
	...
	<nav>
		<ul id="menu">
			<li id="menu_li"><button onclick="location.href='./food/Result.jsp?str=채소'">채소</button>
			<li id="menu_li"><button onclick="location.href='./food/Result.jsp?str=육류'">육류</button>
			<li id="menu_li"><button onclick="location.href='./food/Result.jsp?str=유제품'">유제품</button>
			<li id="menu_li"><button onclick="location.href='./food/Result.jsp?str=소스류'">소스류</button>
		</ul>
	</nav>
